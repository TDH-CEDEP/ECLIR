...
• Designed with modular, scalable architecture suitable for additional message
types or programs
...
• Retrieve unique identifiers and critical data points from the NEDSS Base System
(NBS) surveillance system
